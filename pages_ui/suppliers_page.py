...
def render():
    ...
    st.title("🏭 Suppliers")
    st.caption("View which medicines each supplier provides and their stock levels.")
    ...
    if selected_supplier and selected_supplier != "Select":
        ...
        st.info("👈 Select a supplier from the sidebar to view their medicines and stock levels.")
